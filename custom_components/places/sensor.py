...
class Places(Entity):
    ...
    def do_update(self, reason):
        ...
        if proceed_with_update == False:
            _LOGGER.debug( "(" + self._name + ") Skipping update because some data could not be retrieved" )
        ...
        if previous_state == 'Initializing...' and calculations_done == True:
